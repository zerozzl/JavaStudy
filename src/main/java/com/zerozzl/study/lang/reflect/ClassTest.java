...
public class ClassTest {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		System.out.println("------");
		// 会初始化
		Class clazz2 = Class.forName("com.zerozzl.study.java.lang.reflect.XYZ");
		...
		// 第三种方式获取Class对象
		try {
			Class stuClass3 = Class.forName("com.zerozzl.study.java.lang.reflect.XYZ");// 注意此字符串必须是真实路径，就是带包名的类路径，包名.类名
