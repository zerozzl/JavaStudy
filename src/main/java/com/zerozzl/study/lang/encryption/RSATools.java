...
public class RSATools {
	...
	public static void main(String[] args) throws Exception {
		...
		// 甲方进行数据的加密
		byte[] code1 = RSATools.encryptByPrivateKey(str.getBytes(), privateKey);
		System.out.println("加密后的数据：" + Base64.encodeBase64String(code1));
		System.out.println("===========乙方使用甲方提供的公钥对数据进行解密==============");
		// 乙方进行数据的解密
		byte[] decode1 = RSATools.decryptByPublicKey(code1, publicKey);
		...
		System.out.println("原文:" + str);
		// 乙方使用公钥对数据进行加密
		byte[] code2 = RSATools.encryptByPublicKey(str.getBytes(), publicKey);
		...
		// 甲方使用私钥对数据进行解密
		byte[] decode2 = RSATools.decryptByPrivateKey(code2, privateKey);
